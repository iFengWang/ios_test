...
@interface XSYquickOperationFlowLayout()

@property (strong, nonatomic) NSMutableArray *allAttributes;

@end

@implementation XSYquickOperationFlowLayout
...
- (CGSize)collectionViewContentSize {
    return CGSizeMake(kScreenWidth * _dataCount, 200);
}
